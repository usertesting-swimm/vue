...
*   SFC [](https://vuejs.org/api/sfc-script-setup.html)
...
*   In addition, the following APIs are also supported:
    ...
    *   **weex:** remove **weex\_require\_module** api ([a8146c0](https://github.com/vuejs/vue/commit/a8146c0c1074cfd8214a62309c372b25035fd838))
...
This file was generated by Swimm. [Click here to view it in the app](http://localhost:5000/repos/Z2l0aHViJTNBJTNBdnVlJTNBJTNBdXNlcnRlc3Rpbmctc3dpbW0=/docs/gdg8u).